        ...
        <div class="car-specs">
            ...
            <div class="spec-item">
                ...
                <span class="d-flex align-items-center gap-2">
                    <span class="swatch" data-color="{{ $exteriorColor }}"
                        style="display:inline-block;width:12px;height:12px;border-radius:50%;border:1px solid #ddd;"></span>
                    <script>
                        (function(){var el=document.currentScript.previousElementSibling; if(el&&el.dataset&&el.dataset.color){try{el.style.backgroundColor=el.dataset.color;}catch(e){}}})();
                    </script>
