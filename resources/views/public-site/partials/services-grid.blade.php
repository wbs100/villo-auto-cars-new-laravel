			...
			<div class="col-md-4 col-sm-6 mb-4">
				<div class="service-card">
					...
					<p class="service-description">We value your time. Our team ensures lightning-fast
						diagnostics, service, and delivery, getting you back on the road without delay.
					</p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 mb-4">
			...
			<div class="col-md-4 col-sm-6 mb-4">
				<div class="service-card">
					...
					<p class="service-description">From maintenance to complete overhauls, our
						technicians handle manual and automatic transmissions with precision and care.
					</p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 mb-4">
