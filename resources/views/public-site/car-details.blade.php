                        ...
                        <div class="col-xs-12">
                            <div class="header-contacts">
                                ...
                                <a class="header-contacts__item" href="mailto:villoauto@gmail.com"><i
                                        class="icon fa fa-envelope"></i> villoauto@gmail.com</a>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <a href="{{ route('home') }}" class="logo d-none d-lg-block">
                                <img class="logo__img img-responsive" src="{{ asset('NewAssts/img/logo.png') }}"
                            ...
                            <section class="widget">
                                ...
                                <div class="widget-content">
                                    <dl class="list-descriptions list-unstyled">
                                        ...
                                        <dt>ENGINE TYPE:</dt>
                                        <dd>
                                            DOHC 16-valve inline-4, aluminum block and head, direct
                                            fuel injection
                                        </dd>
                                        <dt>DIMENSIONS:</dt>
                                        <dd>
                                ...
                                <div class="widget-content">
                                    <div class="widget-slider owl-carousel owl-theme owl-theme_mod-d enable-owl-carousel"
                                        ...
                                        <div class="widget-slider__item">
                                            <a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img
                                                    class="img-responsive" src="{{ asset('NewAssts/media/banners/1.jpg') }}" height="250" width="306"
                                                    alt="banner" /></a>
                                        </div>
                                        <div class="widget-slider__item">
                                            <a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img
                                ...
                                <div class="widget-content">
                                    <section class="widget-post1 clearfix">
                                        <div class="widget-post1__img">
                                            <img class="img-responsive" src="{{ asset('NewAssts/media/widget-post/1.jpg') }}" height="75" width="75"
                                                alt="foto" />
                                        </div>
                                        <div class="widget-post1__inner">
                                            ...
                                            <div class="widget-post1__description">
                                                Cullam semper aibe vestibulum
                                            </div>
                                        </div>
                                    </section>
                                    <section class="widget-post1 clearfix">
                                        <div class="widget-post1__img">
                                            <img class="img-responsive" src="{{ asset('NewAssts/media/widget-post/2.jpg') }}" height="75" width="75"
                                                alt="foto" />
                                        </div>
                                        <div class="widget-post1__inner">
